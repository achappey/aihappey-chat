...
export type ZaiTranscriptionConfig = {
  /**
...
export const ZaiTranscriptionConfigForm: React.FC<{
  config: ZaiTranscriptionConfig;
  updateConfig: (val: ZaiTranscriptionConfig) => void;
}> = ({ config, updateConfig }) => {
