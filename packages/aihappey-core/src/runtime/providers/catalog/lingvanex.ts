...
export const lingvanex: Provider = {
  name: "Lingvanex",
  description: "Transform your business with AI-powered speech and translation tools. Translate text, documents, audio and images into 100+ languages.",
  icons: [
    {
