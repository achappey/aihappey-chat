...
const onRespond = (result: unknown) => {
 ...
 */
export const AllFieldsEmpty: Story = {
  render: () => (
    <ElicitationForm
      params={{
        ...
        requestedSchema: {
          type: "object",
          required: ["name", "email", "active", "priority", "count"],
          properties: {
            name: {
              type: "string",
              title: "Name",
 ...
 */
export const AllFieldsWithDefaults: Story = {
  render: () => (
    <ElicitationForm
      params={{
...
export const AllFieldsWithDescriptions: Story = {
  render: () => (
    <ElicitationForm
      params={{
